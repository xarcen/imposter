...
const CATEGORIES = [
  { id: "essen", name: "Essen & Trinken", emoji: "🍕", words: [
  ...
  { id: "tiere", name: "Tiere", emoji: "🐘", words: [
  ...
  { id: "sport", name: "Sport", emoji: "⚽", words: [
  ...
  { id: "filme", name: "Filme & Serien", emoji: "🎬", words: [
  ...
  { id: "orte", name: "Länder & Städte", emoji: "🌍", words: [
  ...
  { id: "berufe", name: "Berufe", emoji: "👷", words: [
  ...
  { id: "schule", name: "Schule & Büro", emoji: "🏫", words: [
  ...
  { id: "zuhause", name: "Zuhause & Dinge", emoji: "🏠", words: [
  ...
  { id: "musik", name: "Musik", emoji: "🎵", words: [
  ...
  { id: "games", name: "Games & Internet", emoji: "🎮", words: [
  ...
  { id: "schweiz", name: "Schweiz", emoji: "🇨🇭", words: [
  ...
  { id: "fahrzeuge", name: "Fahrzeuge & Reisen", emoji: "🚗", words: [
  ...
  { id: "promis", name: "Berühmte Personen", emoji: "⭐", words: [
  ...
  { id: "marken", name: "Marken", emoji: "🏷️", words: [
